...
// FIRST ID OF LORDAERON: 15491298
// LAST ID OF LORDAERON: 15522109
...
var baseUrl = 'http://classic.battle.net/war3/ladder/w3xp-game-detail.aspx?Gateway=Lordaeron&GameID='
            ...
            if (numberOfPlayers == 2) { // if this is a "Solo" game
                ...
                if (gameLength.match(r)[0] >= 3 && gameLength.match(r)[0] <= 90) { 
                    ...
                    function createScrapedData() {
                        ...
                        csvOutput.toDisk('./lordaeron.csv', {append: true});
                        gamesParsed++
